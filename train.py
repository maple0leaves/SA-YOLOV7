...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7_SA.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/glove.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='sabifpn', help='save to project/name')
