...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/8sa/weights/best.pt', help='trained weights path')
    ...
    print(
        f'model weights:{opt.weights} size:{get_weight_size(opt.weights)}M Latency:{mean_time:.5f}s +- {std_time:.5f}s fps:{1 / mean_time:.1f}')